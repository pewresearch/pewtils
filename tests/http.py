...
class HTTPTests(unittest.TestCase):
    ...
    def test_canonical_link(self):
        ...
        for original_url, canonical_url in [
            ("https://t.co/H9tE3IlTAH", "https://www.cnn.com/2018/04/01/politics/trump-no-more-daca-deal/index.html?sr=twCNN040118trump-no-more-daca-deal1059AMVODtop"),
            ("http://ow.ly/M5o4N", "https://snjtoday.com/congressman-fran56754k-lobiondo-visits-vineland-high-school/"),
            ("https://bit.ly/2CTCEFW", "https://action.tinaforminnesota.com/page/s/tsm_20190130_backpay"),
            ("https://nbcnews.to/2Yc5JVz", "https://www.nbcnews.com/politics/congress/senate-vote-9-11-first-responders-bill-tuesday-n1032831?cid=sm_npd_nn_tw_ma"),
            ("https://www.c-span.org/Live-Video/C-SPAN", "https://www.c-span.org/Live-Video/C-SPAN"),
            ("http://bit.ly/ascWO6", "http://irtl.org/html/DanCoats.mp3"),
            ("https://www.google.com/maps/d/viewer?mid=zQ8Zk-5ey-Y8.kgD9Rxu8JCNQ&hl=en&usp=sharing", "https://www.google.com/maps/d/viewer?mid=1NQVHeBBcVAnz9JwX1frZxX1ZgjY"),
            ("https://goo.gl/images/WS5JSd", "https://www.healthcare.gov/blog/sign-up-by-december-15/"),
    ...
    def test_trim_get_parameters(self):
        ...
        for original_url, trimmed_url in [
            ...
            ("https://httpbin.org/status/200?param=1", "https://httpbin.org/status/200"),
        ]:
            trimmed = trim_get_parameters(original_url, user_agent=user_agent, timeout=30)
    ...
    def test_link_shortener_map(self):
        ...
        from pewtils.http import VANITY_LINK_SHORTENERS, HISTORICAL_VANITY_LINK_SHORTENERS
        user_agent = "Mozilla/5.0 (compatible; MSIE 10.0; Macintosh; Intel Mac OS X 10_7_3; Trident/6.0)'"
